    ...
    <div id="content">
                ...
                <ul class="navbar-nav m-auto flex-wrap">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="#support">Support Partner</a></li>
        ...
        <main>
            ...
            <section id="layanan" class="layanan">
                ...
                <div id="cara-investasi" name="legalitas" class="ghaffar-investment-flow mb-5">
                ...
                <section id="w" name="workflow" class="workflow ghaffar-investment-flow h-auto my-lg-5">
            ...
            <section id="support" name="kerjasama" class="kerjasama h-auto py-5">
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingOne">
                                <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                    ...
                                    Apa kelebihan berinvestasi di CV Ghaffar Farm Bersaudara?
                                </button>
                            </h2>
                            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                                data-bs-parent="#qaAccordion">
                                <div class="accordion-body">
                                    Ada 5 kelebihan utama berinvestasi di perusahaan kami:
                                    <ol>
                                        <li>Pasar daging sapi selalu terbuka dengan harga yang stabil.</li>
                                        <li>Biaya investasi yang fleksibel, mulai dari 50 juta hingga 16 miliar rupiah.
                                        </li>
                                        <li>Investor dapat berkunjung langsung ke farm dan menikmati suasana peternakan.
                                        </li>
                                        <li>Pasar ekspor tersedia mulai dari tahun 2024.</li>
                                        <li>Rapat terbuka investor setiap bulan dengan informasi terkini.</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingTwo">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    ...
                                    Berapa nilai minimal dan maksimal investasi di CV Ghaffar Farm Bersaudara?
                                </button>
                            </h2>
                            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                                data-bs-parent="#qaAccordion">
                                <div class="accordion-body">
                                    Nilai investasi minimal di perusahaan kami adalah 50 juta rupiah untuk 5 ekor sapi,
                                    dan nilai maksimalnya adalah 16 miliar rupiah.
                                    Program ini tersedia sepanjang tahun dengan jadwal setiap tanggal 25 setiap bulan.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingThree">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    ...
                                    Bagaimana sistem bagi hasil investasi di CV Ghaffar Farm Bersaudara?
                                </button>
                            </h2>
                            <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                                data-bs-parent="#qaAccordion">
                                <div class="accordion-body">
                                    Sistem bagi hasil yang kami terapkan adalah 50%:50%. Seutuhnya milik investor tanpa
                                    ada potongan biaya lain. Kami juga menjamin keamanan investasi dengan adanya
                                    asuransi bagi ternak sapi yang diikutsertakan.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingFour">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    ...
                                    Bagaimana CV Ghaffar Farm Bersaudara memastikan kualitas daging yang dijual?
                                </button>
                            </h2>
                            <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour"
                                data-bs-parent="#qaAccordion">
                                <div class="accordion-body">
                                    Kami memastikan bahwa setiap sapi yang dijual memenuhi standar kualitas tinggi
                                    melalui proses pemeriksaan kesehatan dan sertifikasi yang ketat. Selain itu, pakan
                                    yang digunakan berasal dari limbah pertanian yang difermentasi untuk meningkatkan
                                    nilai gizi sapi.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingFive">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    ...
                                    Bagaimana sistem kemitraan di CV Ghaffar Farm Bersaudara?
                                </button>
                            </h2>
                            <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive"
                                data-bs-parent="#qaAccordion">
                                <div class="accordion-body">
                                    CV Ghaffar Farm Bersaudara menjalin kemitraan dengan peternakan kecil hingga besar
                                    di seluruh pulau Sumatera, Riau, Jawa, dan Nusa Tenggara. Kami tidak hanya
                                    menyediakan bibit sapi, tetapi juga terlibat dalam proses penggemukan sapi.
                                </div>
                            </div>
                        </div>
