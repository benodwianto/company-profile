...
<nav class="d-flex align-items-center">
    ...
    <ul class="navbar-nav ms-auto d-flex flex-row align-items-center">
        <li class="topbar">
            <a href="../logout.php" class="nav-link btn btn-light border border-danger text-danger d-flex align-items-center p-2">
        ...
        <li class="topbar">
            ...
            <?php if ($isAdmin) : ?>
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                    <li>
                        <a href="HalamanTambahAdmin.php" class="dropdown-item btn btn-primary">
                            Tambah Admin
                        </a>
                    </li>
